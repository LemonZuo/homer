...
type SmsForwarder struct {
	...
	AuthMode       int       `gorm:"column:auth_mode;default:1" json:"auth_mode"`
	SignKey        string    `gorm:"column:sign_key;size:512" json:"sign_key"`
	RSAPublicKey   string    `gorm:"column:rsa_public_key;type:text" json:"rsa_public_key"`
	SM4Key         string    `gorm:"column:sm4_key;size:64" json:"sm4_key"`
