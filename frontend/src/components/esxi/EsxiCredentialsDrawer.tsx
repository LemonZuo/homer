...
export function EsxiCredentialsDrawer({
  open,
  onOpenChange,
  credentials,
  onAdd,
  ...
  onAdd: () => void
  onEdit: (c: EsxiCredential) => void
  onDelete: (c: EsxiCredential) => void
}) {
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent>
        <DrawerHeader>
          <DrawerTitle>ESXi 登录凭证</DrawerTitle>
          <DrawerDescription>
            ESXi 模块专属 SSH 凭证库;一份登录身份可被多台 ESXi 机器共用
          </DrawerDescription>
        </DrawerHeader>
