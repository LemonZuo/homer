...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-x-0 bottom-0 z-50 mt-24 flex max-h-[92vh] flex-col rounded-t-2xl border-t border-border bg-card outline-none',
        className,
      )}
      {...props}
    >
...
export const DrawerHeader = ({
  ...
  <div className={cn('grid gap-1 p-4 text-left', className)} {...props} />
)
