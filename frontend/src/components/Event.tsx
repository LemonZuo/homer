...
import { useEventRecords } from './event/useEventRecords'
...
export default function Event() {
  ...
  const { records, loading, notifying, save, remove, toggle, notify } = useEventRecords()
  ...
  const openEdit = (record: EventItem) => {
    setEditing(record)
    setModalOpen(true)
  }
